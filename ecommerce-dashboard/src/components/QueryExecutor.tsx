...
import { FaPlay, FaHistory, FaExclamationTriangle } from 'react-icons/fa';
          ...
          <div className="space-y-2">
            {exampleQueries.map((example) => (
              <button
                ...
                className="w-full text-left p-3 hover:bg-gray-50 rounded-lg border border-gray-200 transition-colors duration-200"
              >
              ...
              <div className="space-y-2">
                {queryHistory.map((q, index) => (
                  <button
                    key={index}
                    onClick={() => setQuery(q)}
                    className="w-full text-left p-2 hover:bg-gray-50 rounded-lg text-xs font-mono text-black"
                  >
                    {q}
                  </button>
                ))}
